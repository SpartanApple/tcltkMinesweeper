...
set bomb [image create photo -file minesweeperBomb.png]
set empty [image create photo -file minesweeperEmpty.png]
set redBomb [image create photo -file minesweeperBombRedX.png]
set zero [image create photo -file grey.png]

set one [image create photo -file one.png]
set two [image create photo -file two.png]
set three [image create photo -file three.png]
set four [image create photo -file four.png]
set five [image create photo -file five.png]
set six [image create photo -file six.png]
set seven [image create photo -file seven.png]
set eight [image create photo -file eight.png]
# --------------------------------------------------------
